...
No, this software uses open databases. It only provides access to legal, open-access research papers.

*Will this work on a Mac?*
These instructions describe the Windows process. The tool is designed for use within the Claude Desktop environment on Windows systems.

*What if I cannot find a paper?*
Sometimes a paper exists, but it lacks a legal open-access version. The tool will inform you if no downloadable PDF exists.

*How do I update the software?*
Check the download page periodically for new versions. Run the new installer to update your current files.

*Is my data private?*
The software works locally on your machine. Your search history stays within your own environment unless you share your chat logs with the AI provider.
